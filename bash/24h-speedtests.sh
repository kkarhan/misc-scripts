...
#   100 tests starting with 1 ending with 100
        do
                ...
                #   selecting speedtest server #32412, binding the ethernet interface, not showing progress bars, >
                echo "Network Test " $i " done!"
                echo; echo;
                #   adding two seperate lines
                sleep 900
                #   this will set the wait 15 min = 900s between tests.
                #       as 15*24 = 96, this test will have some sufficient overlap and will provide 24hrs of test >
done
